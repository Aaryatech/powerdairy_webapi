...
public interface GetCurrentStockRepository extends JpaRepository<GetCurrentStock, Integer>{
	...
	@Query(value="SELECT\r\n" + 
			...
			"        0) AS return_qty,\r\n" + 
			"        coalesce((Select\r\n" + 
			"            sum(t_mfg_return_detail.item_return_qty)            \r\n" + 
			"        FROM\r\n" + 
			"            t_mfg_return,\r\n" + 
			"            t_mfg_return_detail\r\n" + 
			"        where\r\n" + 
			"            t_mfg_return.date=:date and\r\n" + 
			"            t_mfg_return_detail.t_return_id = t_mfg_return.t_return_id\r\n" + 
			"            and m_item.item_id=t_mfg_return_detail.item_id),\r\n" + 
			"        0) AS hub_return_qty       \r\n" + 
			"    FROM\r\n" + 
			"        m_item       \r\n" + 
			"    where\r\n" + 
